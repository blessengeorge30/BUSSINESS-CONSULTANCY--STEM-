...
<title>:: Stem Consultency Admin :: Home</title>
...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="assets/images/stemlogo.png" width="115" alt="Stem"><span class="m-l-10"></span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li><a href="enquries"><i class="zmdi zmdi-account"></i><span>Enquries</span></a></li>
            <li><a href="queries"><i class="zmdi zmdi-account"></i><span>Queries</span></a></li>
         
            
            <!--<li><a href="my-profile.html"><i class="zmdi zmdi-account"></i><span>Our Profile</span></a></li>-->
               <li><a href="index"><i class="zmdi zmdi-account"></i><span>Logout</span></a></li>
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Dashboard</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index"><i class="zmdi zmdi-home"></i> Stem Consultency</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card widget_2 big_icon ">
                    <div class="body">
                        <?php
                            $sql="select count(*) FROM enquiries";
                            $result=mysqli_query($conn,$sql);
                            $row=mysqli_fetch_row($result);
                            $ecount=$row[0];
                        ?>
                        <h6>Enquiries</h6>
                        <h2><?php echo $ecount; ?> <small class="info">Received</small></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card widget_2 big_icon ">
                    <div class="body">
                        <?php
                            $sql="select count(*) FROM modal_data";
                            $result=mysqli_query($conn,$sql);
                            $row=mysqli_fetch_row($result);
                            $ecount=$row[0];
                        ?>
                        <h6>Queries</h6>
                        <h2><?php echo $ecount; ?> <small class="info">Received</small></h2>
                         <small>Total Recieved Queries</small>
                        <div class="progress">
